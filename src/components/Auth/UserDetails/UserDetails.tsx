...
const UserDetails: React.FC<UserDetailsProps> = ({
  ...
  const { addProxyCall, errorMessage, transactionSuccess } = useProxyCall(
    account,
    () => {
  ...
  return (
    <>
      ...
      {registrationStatus === 'success' && <p>User registered successfully</p>}
      {registrationStatus === 'userExists' && <p>User already exists</p>}
      {registrationStatus === 'error' && <p>Error during user registration</p>}
